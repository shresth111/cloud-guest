"""FastAPI dependencies for the Port Forwarding Management domain.
...
from .repository import PortForwardingRepository, PortForwardingRepositoryProtocol
from .service import PortForwardingService


def get_port_forwarding_repository(
    db: AsyncSession = Depends(get_db_session),
) -> PortForwardingRepositoryProtocol:
    return PortForwardingRepository(db)


def get_port_forwarding_service(
    repository: PortForwardingRepositoryProtocol = Depends(
        get_port_forwarding_repository
    ),
...
__all__ = ["get_port_forwarding_repository", "get_port_forwarding_service"]
