...
class CrossLocationPortForwardingRuleAccessError(PortForwardingError):
    """A caller confined to particular sites reached a port-forwarding rule
    at another site.

    Distinct from ``CrossOrganizationPortForwardingRuleAccessError``:
    ...
    def __init__(self) -> None:
        super().__init__(
            "Cannot access a port-forwarding rule at a location outside "
            "your own scope",
