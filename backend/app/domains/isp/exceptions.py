...
class CrossLocationIspLinkAccessError(IspError):
    """A caller confined to particular sites reached an ISP link
    at another site.

    Distinct from ``CrossOrganizationIspLinkAccessError``:
    ...
    def __init__(self) -> None:
        super().__init__(
            "Cannot access an ISP link at a location outside "
            "your own scope",
