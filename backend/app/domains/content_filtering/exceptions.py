...
class CrossLocationContentFilterRuleAccessError(ContentFilteringError):
    """A caller confined to particular sites reached a content filter rule
    at another site.

    Distinct from ``CrossOrganizationContentFilterRuleAccessError``:
    ...
    def __init__(self) -> None:
        super().__init__(
            "Cannot access a content filter rule at a location outside "
            "your own scope",
