...
from app.domains.analytics.dependencies import (
    get_dashboard_service as get_analytics_dashboard_service,
)
...
def get_dashboard_service(
    analytics_dashboard: AnalyticsDashboardService = Depends(
        get_analytics_dashboard_service
    ),
    platform_dashboard: PlatformDashboardService = Depends(
