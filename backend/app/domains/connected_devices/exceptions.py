...
class CrossLocationConnectedDeviceAccessError(ConnectedDeviceError):
    """A caller confined to particular sites reached a connected device
    at another site.

    Distinct from ``CrossOrganizationConnectedDeviceAccessError``:
    ...
    def __init__(self) -> None:
        super().__init__(
            "Cannot access a connected device at a location outside "
            "your own scope",
