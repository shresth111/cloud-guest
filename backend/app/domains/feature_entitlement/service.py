...
FEATURE_META: dict[PlanFeatureKey, tuple[str, str, str]] = {
    ...
    PlanFeatureKey.SSO: ("SSO", "Single sign-on integration (SAML/OIDC)", "auth"),
    PlanFeatureKey.SMS_AUTH: ("SMS Auth", "SMS-based authentication for guests", "auth"),
    PlanFeatureKey.EMAIL_AUTH: ("Email Auth", "Email-based authentication for guests", "auth"),
    PlanFeatureKey.VOUCHER: ("Vouchers", "Voucher-based guest access", "guest"),
    PlanFeatureKey.MULTI_LANGUAGE: ("Multi Language", "Multi-language portal support", "portal"),
    ...
    PlanFeatureKey.WEBHOOKS: ("Webhooks", "Webhook notifications and integrations", "integrations"),
    PlanFeatureKey.RADIUS: ("RADIUS", "RADIUS authentication and accounting", "network"),
    PlanFeatureKey.BANDWIDTH_MGMT: ("Bandwidth Management", "Per-client bandwidth policies", "network"),
    PlanFeatureKey.QOS: ("QoS", "Quality of Service configuration", "network"),
    PlanFeatureKey.FIREWALL: ("Firewall", "Advanced firewall rules", "network"),
    PlanFeatureKey.VLAN: ("VLAN", "VLAN management and segmentation", "network"),
    PlanFeatureKey.DHCP: ("DHCP", "DHCP pool management", "network"),
    PlanFeatureKey.DNS: ("DNS", "DNS management", "network"),
    ...
    PlanFeatureKey.BRANDING: ("Branding", "Portal branding and customization", "branding"),
    ...
    PlanFeatureKey.SCHEDULED_REPORTS: ("Scheduled Reports", "Automated scheduled report delivery", "reports"),
    PlanFeatureKey.PROVISIONING: ("Zero-Touch Provisioning", "Automated router provisioning", "provisioning"),
    PlanFeatureKey.GUEST_ANALYTICS: ("Guest Analytics", "Detailed guest behavior analytics", "analytics"),
