...
class CrossLocationHotspotProfileAccessError(HotspotError):
    """A caller confined to particular sites reached a hotspot profile
    at another site.

    Distinct from ``CrossOrganizationHotspotProfileAccessError``:
    ...
    def __init__(self) -> None:
        super().__init__(
            "Cannot access a hotspot profile at a location outside "
            "your own scope",
