...
from .exceptions import (
    CrossLocationHotspotProfileAccessError,
...
class HotspotService:
    ...
    async def create_profile(
        ...
        *,
        ...
        ensure_not_controller_managed(router, feature="Guest WiFi Profiles")
    ...
    async def get_profile(
        ...
        *,
        ...
        enforce_entity_location(
            entity_location_id=getattr(profile, "location_id", None),
            caller_location_scope=self.caller_location_scope,
            error=CrossLocationHotspotProfileAccessError(),
        )
        return profile
