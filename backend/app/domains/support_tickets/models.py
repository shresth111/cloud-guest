...
every organization on the Master dashboard. Deliberately a single flat
table with no separate "comments"/"activity log" table in this pass --
mirrors how ``app.domains.guest_access``'s own Phase 1 kept its rule tables
single-table, simple CRUD, no state-machine table of their own.
